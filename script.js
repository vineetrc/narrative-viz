document.addEventListener('DOMContentLoaded', function() {
    ...
    d3.csv('./data/cleaned_nba_playoff_stats.csv').then(function(data) {
        ...
        const renderAnnotations3 = (filteredData) => {
            svg3Annotations.selectAll("*").remove(); // Clear previous annotations
            const annotations3 = [
                {
                    note: {
                        label: "",
                    ...
                    x: xScale3(filteredData.find(d => d.Player === "Nikola Joki?").efg_perc),
                    y: yScale3(filteredData.find(d => d.Player === "Nikola Joki?").pts),
                    dx: 60,
                    dy: 60
                },
            ];
        ...
        function updateChart() {
            ...
            // Conditionally add the annotation for Nikola Jokic
            if (selectedPosition === 'All' && selectedTeam === 'All') {
                renderAnnotations3(data);
            } else {
